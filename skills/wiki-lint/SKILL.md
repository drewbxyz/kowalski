...
**"Lint carries forward" is the defining principle of this skill** (per CLAUDE.md): a finding flagged open in two consecutive reports is a process failure, not a routine note. Run this before any fresh scanning.
